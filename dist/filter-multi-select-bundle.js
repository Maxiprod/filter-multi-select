(function ($) {
    ...
    var FilterMultiSelect = /** @class */function () {
      ...
      FilterMultiSelect.prototype.initialize = function () {
        ...
        this.skeletonLines.forEach(function (o) {
          return _this.skeleton.append(o);
        });
        this.options.forEach(function (o) {
          return o.initialize();
        });
      ...
      FilterMultiSelect.prototype.filtrarAsync = function (oldText) {
        ...
        this.lazyLoadingFunction({
          texto: text,
          itensPorLoad: this.maxLazyLoadedAmount
        }, this, this.onFiltro);
      };
      FilterMultiSelect.prototype.filtrar = function (text) {
        ...
        this.options.forEach(function (o, i) {
          ...
          if (label.indexOf(texto) !== -1 && shouldFilter) {
            //magic number 
            o.show();
            showing.push(i);
          } else {
      ...
      FilterMultiSelect.prototype.updateDropdownList = function () {
        ...
        if (this.isSearchBox) {
          ...
          this.setLoading();
          setTimeout(function () {
            return _this.filtrarAsync(text);
          }, 500);
          this.filterText = text;
          this.showing = showing;
          return;
      ...
      FilterMultiSelect.prototype.setLoading = function () {
        ...
        this.skeletonLines.forEach(function (o) {
          return o.style.width = Math.random() * 60 + 40 + '%';
        });
      };
      ...
      FilterMultiSelect.prototype.getNoSelectedOptionsAsJson = function (includeDisabled) {
        ...
        var data = {};
        var a = this.getNoSelectedOptions(includeDisabled).map(function (o) {
          return o.getValue();
        });
        data[this.getName()] = a;
        var c = JSON.stringify(data, null, "  ");
    ...
    $__default["default"].fn.filterMultiSelect.multiSelector = undefined;
